...
Якщо обидва репозиторії лежать поруч, простіше запустити `make ui` **у
`oddinvest`**: він перегенерує манiфест і синхронізує вендор сюди однією
командою. Порядок важливий саме такий — синк звіряє файли за sha256 з
манiфеста, тож застарілий манiфест перетворює перевірку на формальність.
