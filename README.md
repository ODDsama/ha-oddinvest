...
**Що вимагає уваги** (`binary_sensor`, усі `device_class: problem`)

| Ключ | `on` означає |
|---|---|
| `has_uninvested` | є гроші, що чекають перевкладення |
| `reinvest_ready` | на рахунку вистачає щонайменше на один папір |
| `concentration_breach` | заданий ліміт концентрації перевищено; атрибут `breaches` |
| `data_stale` | числа старші за 36 год — сервіс живий, але дані стоять |
