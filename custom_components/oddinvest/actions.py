...
# ---------------------------------------------------------------- REST
#
# Заголовки потрібні і діям (__init__._request), і перевірці в config flow
# (_probe), а тест вантажить цей файл напряму — тож перевіряє саме той код,
# що їде в запит, а не копію. Доти вони жили окремим модулем rest.py з
# однією функцією.
